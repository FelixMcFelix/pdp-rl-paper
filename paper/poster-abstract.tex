...
\Cref{fig:lat-cumul} shows that our main design (\coopfw) achieves order-of-magnitude latency improvements over our single-threaded variant (\indfw) and a host implementation, as well as considerably tighter tail behaviour on the SmartNIC.
...
\begin{figure}
	...
	\begin{subfigure}{0.45\linewidth}
		\resizebox{1.0\linewidth}{!}{
			\includegraphics{plots/latency-cumul}
			\vspace{-10pt}
		}
	...
	\begin{subfigure}{0.45\linewidth}
		\resizebox{1.0\linewidth}{!}{
			\includegraphics{plots/latency-cumul-broad}
		}
