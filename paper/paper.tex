...
We present \emph{\approachshort{}}---\approach{}---to the best of our knowledge the first online RL in the dataplane...
...
?? Where to mention that algo 1 omits epsilon greedy etc?
...
A recent line of research in the community has been to investigate the use of \emph{Binarised/Bitwise Neural Networks} (BNNs)~\parencite{DBLP:conf/nips/HubaraCSEB16,DBLP:journals/corr/KimS16,DBLP:journals/corr/MiyashitaLM16} for line-rate, low latency packet classification.
...
?? Future directions for community: want to see more general-purpose async compute on-chip! Larger form-factors! More asynchrony!

?? Future directions; transfer learning between classical methods into faster offline-only?
