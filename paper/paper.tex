...
?? \Cref{fig:single-and-parallel} is explained in \cref{sec:action-and-update-computation}
...
\Cref{fig:vary-work,fig:vary-work-latency} show how policy complexity affects complete update costs and state-action latency respectively, scaling from a bias tile up to the full DDoS policy size\footnote{Input vectors here all have 20 elements regardless of the policy design.}.
