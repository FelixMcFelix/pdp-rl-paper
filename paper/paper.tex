...
\begin{figure}
	...
	\caption{?? Max Parallelisation. ?? Bitdepth affects independent cores more.}
\end{figure}
...
\begin{figure}
	...
	\caption{?? Max-size work (129 work-items). ?? Need to dedicate 3 worker to beat independent cores. ?? Sharper perf increase when new physical core added. ?? up to 31 due to master thread.}
\end{figure}
