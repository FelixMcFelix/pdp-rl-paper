...
set key samplen 2 spacing 1 width -2 above horizontal
...
PresentationNames[1] = "\\Coopfw{}"
PresentationNames[2] = "\\Indfw{}"
...
myTitle(i) = sprintf("\\scriptsize\\emph{%s} (\\SI{%d}{\\bit})", PresentationNames[(i / 3) + 1], BitDepths[(i % 3) + 1])
