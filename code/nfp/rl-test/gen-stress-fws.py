...
fw_path_base = "fws/stress/"
wc_header_file_to_write = "worker_config_marker.h"
stress_header_file_to_write = "stress_marker.h"
tile_header_file_to_write = "tile_marker.h"
build_bat = "rl-test-stress_rebuild.bat"
fw_to_copy = "rl-test-stress.nffw"
...
nffw_ld_cmd = [
	...
	# -u i12.me0 -l C:\Users\Kyle\gits\pdp-rl-paper\code\nfp\rl-test\out\rl_stressor.list\rl_stressor.list
	"-u", "i12.me0",
	"-l", cwd + r"\out\rl_stressor.list\rl_stressor.list",
	"-u", "i12.me1",
	"-l", cwd + r"\out\rl_stressor.list\rl_stressor.list",
...
def write_stress_h_file(rate):
	with open(stress_header_file_to_write, "w+") as of:
		of.write("#ifndef _STRESS_MARKER_H\n#define _STRESS_MARKER_H\n")
		contents = "#define STRESS_TEST_RATE {}\n".format(rate)
		of.write(contents)
		of.write("#endif /* !_STRESS_MARKER_H */")
...
def main():
	...
	for name, tags, rate in work_sets:
		write_wc_h_file(tags)
		write_tile_h_file(tags)
		write_stress_h_file(rate)
